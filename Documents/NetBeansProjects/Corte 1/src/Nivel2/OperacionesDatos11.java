...
public class OperacionesDatos11 {
       public static void main(String[] x){
        new OperacionesDatos11();
    }
    public OperacionesDatos11(){
        float datos [] = this.configurar();  // solo se llama el primer metodo porque los demas se van llamando de forma escalonada     
