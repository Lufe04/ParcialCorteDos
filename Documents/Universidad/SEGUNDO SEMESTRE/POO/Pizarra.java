  ...
  @SuppressWarnings("unchecked")
    ...
    private void drawCylinder(){
        ...
        int x, y, r, r2, h, altinc;
            x=Integer.parseInt(JOptionPane.showInputDialog("Digite coordenada X del centro: "));
            y=Integer.parseInt(JOptionPane.showInputDialog("Digite la coordenada Y del centro: "));
            r=Integer.parseInt(JOptionPane.showInputDialog("Digite el radio de la parte inferior del Tronoco Cono: "));
            r2=Integer.parseInt(JOptionPane.showInputDialog("Ingrese el radio de la parte superior del Tronco Cono"));
